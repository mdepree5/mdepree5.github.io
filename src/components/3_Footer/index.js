...
const Footer = ({mode}) => {
  return (
    <footer className={`${mode}-footer footer`}>
      ...
      <ExternalLink link='https://www.linkedin.com/in/mitch-depree-4a5686155/' image='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linkedin/linkedin-original.svg' />
